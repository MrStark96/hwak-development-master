...
@section('content')
<div class="heroSec aniView invest pink" style="background-image:url({{ asset('images/hawknestInvest/invest4-2.jpg') }})" id="heroSec">
        ...
        <div class="row justify-content-center">
            <div class="col-10 col-md-8 col-lg-6 col-xl-5">
                ...
                <div class="container-fluid answers">
                    <form action="/invest-step-4" method="POST">
                        @csrf
                        <div class="row justify-content-center">
                            ...
                            <div class="col-12">
                                ...
                                <input type="range" min="1" max="9751" value="4875" class="custom-range" id="myRange">
