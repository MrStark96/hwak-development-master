...
@section('content')
<div class="heroSec aniView invest pink" style="background-image:url({{ asset('images/hawknestInvest/invest7.jpg') }})" id="heroSec">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-10 col-md-8 col-lg-6 col-xl-5">
                <div class=" question">
                    Max Square Feet per unit
                </div>

                <div class="container-fluid answers">
                    <form action="/invest-step-7" method="POSt">
                        @csrf
                        <div class="row justify-content-center">
                            ...
                            <div class="col-12">
                                ...
                                <input type="range" min="1" max="96" value="50" class="custom-range" id="myRange">
