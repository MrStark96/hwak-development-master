...
@section('content')
<div class="heroSec aniView invest blue" style="background-image:url({{ asset('images/hawknest/2.jpg') }})" id="heroSecInvest2">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-10 col-md-8 col-lg-6 col-xl-5">
                <div class="question">
                    Bedrooms / Bathrooms <br>per unit
                </div>
                <div class="answers container-fluid">
                    <form action="/invest-step-2" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-6">
...
@section('footer_scripts')
    <script type="text/javascript">
        ...
        let heroSec = document.getElementById('heroSecInvest2');
