...
@section('content')
<div class="heroSec aniView invest blue" style="background-image:url({{ asset('images/hawknest/4.jpg') }})" id="heroSec">
        ...
        <div class="row justify-content-center">
            <div class="col-10 col-md-8 col-lg-6 col-xl-5">
                ...
                <div class="container-fluid answers" style="height: 280px;">
                    <form class="w-100 h-100" action="/invest-step-6" method="POST">
                        @csrf
                        <div id="map" style="width: 100%; height: 70%; margin-top: 15px; margin-bottom: 5px;">
                        </div>
...
@section('footer_scripts')
    <script type="text/javascript">
        ...
        function newBubble() {
            ...
            stopButton.style.backgroundColor = '#2bb43f';
            resetButton.setAttribute('disabled', 'false');
            resetButton.style.backgroundColor = '#2bb43f';
        ...
        function stopMarkers() {
            ...
            stopButton.style.backgroundColor = '#a09d80';
            startButton.style.backgroundColor = '#2bb43f';
