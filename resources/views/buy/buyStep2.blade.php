...
@section('content')
    <div class="heroSec aniView buy blue" style="background-image:url({{ asset('images/hawknest/rentStepBuilding2.png') }})" id="heroSecBuy2">
        <div class="birdNestR"></div>
        <div class="NestL"></div>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-10 col-md-8 col-lg-6 col-xl-5">
                    <div class="question" style="letter-spacing: 0;">
                        Bedrooms / Bathrooms
                    </div>
                    <div class="answers container-fluid">
                        <form action="/buy-step-2" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-6">
...
@section('footer_scripts')
    <script type="text/javascript">
        ...
        let heroSec = document.getElementById('heroSecBuy2');
        let toggleView = document.getElementById('toggleView');
        console.log(toggleViewValue);
