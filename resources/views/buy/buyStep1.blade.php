...
@section('content')
    <div class="heroSec aniView buy pink" id="heroSec" style="background-image:url({{ asset('images/hawknest/1.jpg') }}); background-size: cover">
            ...
            <div class="row justify-content-md-center">
                <div class="col-5">
                    ...
                    <div class="answers container-fluid p-0">
                        <form action="/buy-step-1" method="post">
                            @csrf
                                ...
                                <div class="row m-2 justify-content-between">
                                    <div class="col-2 p-0">
                                        <div class="radiobtn">
                                            ...
                                            <label for="house" style="height: 100px;"><div style="height: 80px; font-size: 12px;"><span style="margin-bottom: 12px;">1</span><br> House</div></label>
                                        </div>
                                    </div>
                                    <div class="col-2 p-0">
                                        <div class="radiobtn">
                                            <input type="checkbox" id="condo" name="Condo" value="Condo" />
                                            <label for="condo" style="height: 100px;"><div style="height: 80px; font-size: 12px;"><span style="margin-bottom: 12px;">2</span> Condo</div></label>
                                        </div>
                                    </div>
                                    <div class="col-2 p-0">
                                        <div class="radiobtn">
                                            <input type="checkbox" id="emptyLot" name="EmptyLot" value="EmptyLot" />
                                            <label for="emptyLot" style="height: 100px;"><div style="height: 80px; font-size: 12px;"><span style="margin-bottom: 12px;">3</span> Empty Lot</div></label>
                                        </div>
                                    </div>
                                    <div class="col-2 p-0">
                                        <div class="radiobtn">
                                            <input type="checkbox" id="apartment" name="Apartment" value="Apartment" />
                                            <label for="apartment" style="height: 100px;"><div style="height: 80px; font-size: 12px;"><span style="margin-bottom: 12px;">4</span> Farm / Ranch</div></label>
                                        </div>
                                    </div>
                                    <div class="col-2 p-0">
                                        <div class="radiobtn">
                                            <input type="checkbox" id="townhome" name="Townhome" value="Townhome" />
                                            <label for="townhome" style="height: 100px;"><div style="height: 80px; font-size: 12px;"><span style="margin-bottom: 12px;">5</span> Townhome</div></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
