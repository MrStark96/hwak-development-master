...
@section('content')
    <div class="heroSec normalView buy welcomeRent" style="display: flex; background: white; height: 100%; justify-content: center; align-items: center;">
        <div class="row">
            <div class="col">
    ...
    <div class="heroSec normalView buy" id="heroSec" style="background-image:url({{ asset('images/hawknest/rent14building.png') }}); display: none;">
            ...
            <div class="row justify-content-center">
                <div class="col-5">
                    ...
                    <div class="container-fluid answers">
                        <form action="/buy-step-11" method="post" autocomplete="off">
                            @csrf
                            <div class="row">
                                <div class="col">
