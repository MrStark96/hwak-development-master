...
@section('content')
    <div class="heroSec aniView sell pink" style="background-image:url({{ asset('images/hawknestInvest/invest4-2.jpg') }})" id="heroSec">
            ...
            <div class="row justify-content-center">
                <div class="col-10 col-md-8 col-lg-6 col-xl-5">
                    ...
                    <div class="container-fluid answers">
                        <form action="/sell-step-3" method="POST">
                            @csrf
                            <div class="row justify-content-center">
