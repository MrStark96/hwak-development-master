...
@section('content')
    <div class="heroSec aniView sell pink" id="heroSec" style="background-image:url({{ asset('images/hawknest/rentStep8Building.jpg') }})">
            ...
            <div class="row justify-content-center">
                <div class="col-5">
                    ...
                    <div class="container-fluid answers">
                        <form action="/sell-step-5" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-12">
