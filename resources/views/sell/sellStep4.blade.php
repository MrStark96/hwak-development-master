...
@section('content')
    <div class="heroSec aniView sell pink" style="background-image:url({{ asset('images/hawknest/4.jpg') }})" id="heroSec">
            ...
            <div class="row justify-content-center">
                <div class="col-10 col-md-8 col-lg-6 col-xl-5">
                    ...
                    <div class="container-fluid answers" style="height: 280px;">
                        <form class="w-100 h-100" action="/sell-step-4" method="POST">
                            @csrf
