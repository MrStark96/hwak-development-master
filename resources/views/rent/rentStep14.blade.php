...
<div class="heroSec normalView rent" id="heroSec" style="background-image:url({{ asset('images/hawknest/rent14building.png') }}); display: none;">
        ...
        <div class="row justify-content-center">
            <div class="col-5">
                ...
                <div class="container-fluid answers">
                    <form action="/rent-step-14" method="post" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col">
