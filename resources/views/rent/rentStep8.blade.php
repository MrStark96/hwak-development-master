...
@section('content')
<div class="heroSec aniView rent pink" id="heroSec" style="background-image:url({{ asset('images/hawknest/rentStep8Building.jpg') }})">
        ...
        <div class="row justify-content-center">
            <div class="col-5">
                <div class="question" style="height: 42px;">
                    What household features are important to you?
                </div>

                <div class="container-fluid answers">
                    <form action="/rent-step-8" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <ul class="checkboxWrap" style="height:150px">
                                    ...
                                    <li>
                                        <label><i><img width="20" src="{{ asset('images/icons/rentStep8/views.png') }}"></i>Views
                        ...
                        <button class="btn btn-warning" type="submit" id="nextButton"><span>Next</span><i class="fa fa-spinner fa-spin" style="display: none;"></i></button><br>
                        <a href="/rent-step-9">Skip this question <i class="icofont-long-arrow-right"></i></a>
                    </form>
                </div>
            </div>
        </div>
