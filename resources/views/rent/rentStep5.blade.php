...
@section('content')
<div class="heroSec aniView rent" id="heroSec" style="background-image:url({{ asset('images/hawknest/rent5building.png') }})">
        ...
        <div class="row justify-content-center">
            <div class="col-5">
                ...
                <div class="container-fluid answers">
                    <form action="/rent-step-5" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                        ...
                        <a href="/rent-step-6">Skip this question <i class="icofont-long-arrow-right"></i></a>
                    </form>
                </div>
            </div>
        </div>
